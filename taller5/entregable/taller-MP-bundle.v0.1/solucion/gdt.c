...
gdt_entry_t gdt[GDT_COUNT] = {
    ...
    [GDT_IDX_NULL_DESC] =
        {
            ...
            // Cada campo del struct se matchea con el formato que figura en el
            // manual de intel Es una entrada en la GDT.
            .limit_15_0 = 0x0000,
            .base_15_0 = 0x0000,
            .base_23_16 = 0x00,
            .type = 0x0,
    ...
    /* Completar la GDT:
      Es conveniente completar antes las constantes definidas en defines.h y
      valerse de las mismas para definir los descriptores acá. Traten en lo
      posible de usar las macros allí definidas. Tomen el descriptor nulo como
      ejemplo y definan el resto.
     */

};

// Aca hay una inicializacion estatica de una structura que tiene su primer
// componente el tamano y en la segunda, la direccion de memoria de la GDT.
// Observen la notacion que usa.
