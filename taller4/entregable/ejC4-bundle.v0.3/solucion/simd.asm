...
.loopexterno:
    ...
    dec r9
    add r9, r10
    add r9, rdi + BUFFER_OFFSET ; posicion a leer del buffer
        .innerloop:
            ;acc += (int32_t)(*coeff_p++) * (int32_t)(*(in_p--))
            movups xmm1, qword [r9] ; cargo 16 bytes buffer en xmm1
            pmaddwd xmm1, qword [r8] ; multiplicamos los coefs con el buffer
            paddd xmm0,xmm1
            sub rcx, 16
            add r9, 16
            add r8, 16
