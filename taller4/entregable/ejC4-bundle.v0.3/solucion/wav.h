...
typedef enum WavChannelFormat {
  INTERLEAVED, // channel buffer is interleaved e.g. [LRLRLRLR]
  INLINE,      // channel buffer is inlined e.g. [LLLLRRRR]
  SPLIT        // channel buffer is split e.g. [[LLLL],[RRRR]]
} WavChannelFormat;
 ...
 *  @param chanFmt  Format type: INLINE, INTERLEAVED or SPLIT
